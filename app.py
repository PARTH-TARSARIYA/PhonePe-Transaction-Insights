...
# ---------------- LOAD DATA ----------------
agg_transaction = pd.read_csv("E:/internship/Labmentix/Projects/Phone Pe/code & data/agg_transaction.csv")
agg_insurance = pd.read_csv("E:/internship/Labmentix/Projects/Phone Pe/code & data/agg_insurance.csv")
agg_user = pd.read_csv("E:/internship/Labmentix/Projects/Phone Pe/code & data/agg_user.csv")
map_transaction = pd.read_csv("E:/internship/Labmentix/Projects/Phone Pe/code & data/map_transaction.csv")
map_user = pd.read_csv("E:/internship/Labmentix/Projects/Phone Pe/code & data/map_user.csv")
top_transaction = pd.read_csv("E:/internship/Labmentix/Projects/Phone Pe/code & data/top_transaction.csv")
top_user = pd.read_csv("E:/internship/Labmentix/Projects/Phone Pe/code & data/top_user.csv")
