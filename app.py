...
# ---------------- LOAD DATA ----------------
agg_transaction = pd.read_csv("https://github.com/PARTH-TARSARIYA/PhonePe-Transaction-Insights/tree/main/Data/agg_transaction.csv")
agg_insurance = pd.read_csv("https://github.com/PARTH-TARSARIYA/PhonePe-Transaction-Insights/tree/main/Data/agg_insurance.csv")
agg_user = pd.read_csv("https://github.com/PARTH-TARSARIYA/PhonePe-Transaction-Insights/tree/main/Data/agg_user.csv")
map_transaction = pd.read_csv("https://github.com/PARTH-TARSARIYA/PhonePe-Transaction-Insights/tree/main/Data/map_transaction.csv")
map_user = pd.read_csv("https://github.com/PARTH-TARSARIYA/PhonePe-Transaction-Insights/tree/main/Data/map_user.csv")
top_transaction = pd.read_csv("https://github.com/PARTH-TARSARIYA/PhonePe-Transaction-Insights/tree/main/Data/top_transaction.csv")
top_user = pd.read_csv("https://github.com/PARTH-TARSARIYA/PhonePe-Transaction-Insights/tree/main/Data/top_user.csv")
